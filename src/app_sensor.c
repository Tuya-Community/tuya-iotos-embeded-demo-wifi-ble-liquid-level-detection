...
VOID app_report_all_dp_status(VOID)
{
    ...
    dp_arr[0].dpid = DPID_LIQUID_STATE;
    dp_arr[0].type = PROP_ENUM;
    dp_arr[0].time_stamp = 0;
    dp_arr[0].value.dp_value = app_report_data.liquid_state;

    dp_arr[1].dpid = DPID_LIQUID_DEPTH;
    dp_arr[1].type = PROP_VALUE;
    dp_arr[1].time_stamp = 0;
    dp_arr[1].value.dp_value = app_report_data.liquid_depth;
